...
const SearchExercies = ({ bodyPart, setBodyPart}) => {
      ...
      <Stack alignItems='center' mt='37px' justifyContent='center' p='20px'>
        ...
        <Box position='relative' mb='72px'>
          <TextField  sx={{input:{fontWeight:'700', border:'none', borderRadius:'4px'},
                            width:{lg:'900px', xs:'350px'}, backgroundColor:'#fff', borderRadius:'40px'}}
              height='76px'
              value={search}
          ...
          <Button className="search-btn" variant='contained' color='error' onClick={handleSearch}
            sx={{
              bgcolor:'#EE2625', color:'#fff', textTransform:'none', width:{lg:'175px', xs:'80px'},
